...
# MBTI 글자별 선택
first = st.radio("1번째 글자: E or I?", ('E', 'I'), horizontal=True)
second = st.radio("2번째 글자: N or S?", ('N', 'S'), horizontal=True)
third = st.radio("3번째 글자: F or T?", ('F', 'T'), horizontal=True)
fourth = st.radio("4번째 글자: J or P?", ('J', 'P'), horizontal=True)

selected_mbti = first + second + third + fourth
...
if selected_mbti in mbti_menu:
    ...
    st.warning("😅 아직 준비 중인 MBTI입니다. 위 4단계에서 골라주세요!")
